...
(function ( a, b ) {
	var c = a;
	c.version = "0.9.3", c.protocol = 1, c.transports = [], c.j = [], c.sockets = {}, c.connect = function ( a, d ) {
	...
	a.Transport = c, b.util.mixin( c, b.EventEmitter ), c.prototype.onData = function ( a ) {
		...
		return this.socket.setHeartbeatTimeout(), a.type == "heartbeat" ? this.onHeartbeat() : (a.type == "connect" && a.endpoint == "" && this.onConnect(), this.socket.onPacket( a ), this)
