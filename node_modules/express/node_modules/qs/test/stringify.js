...
var qs = require( '../' )
	...
	, query_string_identities = {
		...
		'nested' : [
			...
			{query_string : 'x[y][][z]=1', parsed : {'x' : {'y' : [
				{'z' : '1'}
			]}}},
			{query_string : 'x[y][][z][]=1', parsed : {'x' : {'y' : [
				{'z' : ['1']}
			]}}},
			{query_string : 'x[y][][z]=1&x[y][][w]=2', parsed : {'x' : {'y' : [
				{'z' : '1', 'w' : '2'}
			]}}},
			{query_string : 'x[y][][v][w]=1', parsed : {'x' : {'y' : [
				{'v' : {'w' : '1'}}
			]}}},
			{query_string : 'x[y][][z]=1&x[y][][v][w]=2', parsed : {'x' : {'y' : [
				{'z' : '1', 'v' : {'w' : '2'}}
			]}}},
			{query_string : 'x[y][][z]=1&x[y][][z]=2', parsed : {'x' : {'y' : [
				{'z' : '1'},
				{'z' : '2'}
			]}}},
			{query_string : 'x[y][][z]=1&x[y][][w]=a&x[y][][z]=2&x[y][][w]=3', parsed : {'x' : {'y' : [
				{'z' : '1', 'w' : 'a'},
				{'z' : '2', 'w' : '3'}
			]}}},
